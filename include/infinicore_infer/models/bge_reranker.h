#ifndef MODEL_BGEReranker_H
#define MODEL_BGEReranker_H
...
createBGERerankerWeights(const BGERerankerMeta *,
...
__C __export struct BGERerankerModel *
createBGERerankerModel(const BGERerankerMeta *,
                       const ModelWeights *);

/// @brief 销毁模型
__C __export void
destroyBGERerankerModel(struct BGERerankerModel *);
...
__C __export void
inferBatchBGEReranker(struct BGERerankerModel *, uint32_t bsz,
...
__C __export void
forwardBatchBGEM3(struct BGERerankerModel *, uint32_t bsz,
                  const uint32_t *tokens, const void *masks, uint32_t ntok);
